...
public class FatSecretFetcher {
	...
	private static void getFood() throws UnsupportedEncodingException,
			GeneralSecurityException, IOException, ClientProtocolException {
		Long timestamp = getTimeStamp();
		String params = "format=json&method=foods.search&oauth_consumer_key="
				+ consumerKey + "&oauth_nonce=" + timestamp + "&"
				+ "oauth_signature_method=HMAC-SHA1&oauth_timestamp="
				+ timestamp + "&oauth_version=1.0&" + "search_expression=rice";
